...
if (!Array.prototype.includes) {
  ...
  continuations238[9].push({item : "238_Critical_VN10", s : "that the judge who the jury spoke with earlier today /vindicated the defendant, /and it /was true.", a : "x-x-x yours sick cent eat shown ones sale grow steam heat adventure hamburgers hour enjoyable, fun hill okay park.", n : "CLAIM", q : "The defendant was vindicated by the _______?", unselected_verb : "acquitted", q_ac : "judge", q_aiS1 : "", q_aiS3 : "jury"})
  continuations238[9].push({item : "238_Critical_VN10", s : "that the judge who the jury spoke with earlier today /acquitted the defendant, /and it /was true.", a : "x-x-x yours sick cent eat shown ones sale grow steam heat adventure hamburgers hour enjoyable, fun hill okay park." , n : "CLAIM", q : "The defendant was acquitted by the _______?", unselected_verb : "vindicated", q_ac : "judge", q_aiS1 : "", q_aiS3 : "jury"})
