...
if (!Array.prototype.includes) {
  ...
  continuations238[0].push({item : "238_Critical_VN1", s : "that the teacher who the principal liked /annoyed the student, /but it /was only a malicious smear.",a : "x-x-x apart pre cent hour located mid jack ourselves thick phoenix wall follows, hill sun global ride app generates moons."   , n : "CLAIM ACCUSATION", q : "The student was annoyed by ______?"})
  continuations238[0].push({item : "238_Critical_VN1", s : "that the teacher who the principal liked /failed the student, /but it /was only a malicious smear.",a : "x-x-x apart pre cent hour located mid jack ourselves thick phoenix wall follows, hill sun global ride app generates moons."    , n : "CLAIM ACCUSATION", q : "The student was failed by ______?"})
  
  continuations238[1].push({item : "238_Critical_VN2", s : "that the doctor who the colleague mistrusted /bothered the patients, /but it /seemed hard to believe.",a : "x-x-x else cash cent jack whilst pre holy reinforce arrowheads retailer mid enjoying, goal vs videos hill ring dollars."  , n : "CLAIM FACT", q : "The patients were bothered by ______?"})
  continuations238[1].push({item : "238_Critical_VN2", s : "that the doctor who the colleague mistrusted /cured the patients, /but it /seemed hard to believe.",a : "x-x-x else cash cent jack whilst pre holy reinforce arrowheads retailer mid enjoying, goal vs videos hill ring dollars."  , n : "CLAIM FACT", q : "The patients were cured by ______?"})
  
  continuations238[2].push({item : "238_Critical_VN3", s : "that the president who the farmer admired /impressed the commander, /but it /was entirely bogus.",a : "x-x-x apart glad cent eat ourselves yeah okay meters collide awareness pre disorders, ways wall ice sciences maths.", n : "CLAIM", q : "The commander was impressed by ______?"})
  continuations238[2].push({item : "238_Critical_VN3", s : "that the president who the farmer admired /appointed the commander, /but it /was entirely bogus.",a : "x-x-x apart glad cent eat ourselves yeah okay meters collide awareness pre disorders, ways wall ice sciences maths."  , n : "CLAIM", q : "The commander was appointed by ______?"})
  
  continuations238[3].push({item : "238_Critical_VN4", s : "that the victim who the swimmer rescued /surprised the criminal, /and it /appeared on TV.",a : "x-x-x else anti cent eat toward mid lake teaming adviser overview jack involves, miss dad download hall grow.", n : "CLAIM FACT", q : "The criminal was surprised by ______?"})
  continuations238[3].push({item : "238_Critical_VN4", s : "that the victim who the swimmer rescued /sued the criminal, /and it /appeared on TV.",a : "x-x-x else anti cent eat toward mid lake teaming adviser overview jack involves, miss dad download hall grow." , n : "CLAIM FACT", q : "The criminal was sued by ______?" })
  
  continuations238[4].push({item : "238_Critical_VN5", s : "that the guest who the cousin invited /pleased the uncle, /and it /drove Jill crazy.",a : "x-x-x apart sick hour eat grows pre hill argues letting arsenal push aimed, anti cent cents Heap prime.", n : "CLAIM FACT", q : "The uncle was pleased by ______?"})
  continuations238[4].push({item : "238_Critical_VN5", s : "that the guest who the cousin invited /visited the uncle, /and it /drove Jill crazy.",a : "x-x-x apart sick hour eat grows pre hill argues letting arsenal push aimed, anti cent cents Heap prime." , n : "CLAIM FACT", q : "The uncle was visited by ______?" })
  ...
  continuations238[6].push({item : "238_Critical_VN7", s : "that the driver who the guide called /amazed the tourist, /and it /was absolutely true.",a : "x-x-x apart pre hour know abroad holy dad hence annual realms term founded, cent wall sir healthcare grow.", n : "CLAIM", q : "The tourist was amazed by ______?"})
  continuations238[6].push({item : "238_Critical_VN7", s : "that the driver who the guide called /phoned the tourist, /and it /was absolutely true.",a : "x-x-x apart pre hour know abroad holy dad hence annual realms term founded, cent wall sir healthcare grow." , n : "CLAIM", q : "? The tourist was phoned by ______? @" })
  
  continuations238[7].push({item : "238_Critical_VN8", s : "that the actor who the fans loved /astonished the director, /and it /appeared to be true.",a : "x-x-x apart mid hour eat shown pre hill ford miles treatise cup contains, laws app pregnant cent sir bill.", n : "CLAIM", q : "The director was astonished by ______?"})
  continuations238[7].push({item : "238_Critical_VN8", s : "that the actor who the fans loved /greeted the director, /and it /appeared to be true.",a : "x-x-x apart mid hour eat shown pre hill ford miles treatise cup contains, laws app pregnant cent sir bill." , n : "CLAIM", q : "The director was greeted by ______?" })
  
  continuations238[8].push({item : "238_Critical_VN9", s : "that the banker who the analyst defrauded /excited the customer, /but it /proved to be made up.", a : "x-x-x yours sick cent know stroll cool bus staring hydroxide phoenix jack wherever, pre holy soccer kid runs ride hear.", n : "CLAIM", q : "The customer was excited by ______?"})
  continuations238[8].push({item : "238_Critical_VN9", s : "that the banker who the analyst defrauded /trusted the customer, /but it /proved to be made up.", a : "x-x-x yours sick cent know stroll cool bus staring hydroxide phoenix jack wherever, pre holy soccer kid runs ride hear." , n : "CLAIM", q : "The customer was trusted by ______?" })
 
  continuations238[9].push({item : "238_Critical_VN10", s : "that the judge who the attorney hated /vindicated the defendant, /but it /was a lie.", a : "x-x-x apart mid hour miss shown fat kid enjoying forty customize page disasters, cent hill cat eat jobs.", n : "CLAIM", q : "The defendant was vindicated by _______?"})
  continuations238[9].push({item : "238_Critical_VN10", s : "that the judge who the attorney hated /acquitted the defendant, /but it /was a lie.", a : "x-x-x apart mid hour miss shown fat kid enjoying forty customize page disasters, cent hill cat eat jobs." , n : "CLAIM", q : "The defendant was acquitted by _______?" })
 
  continuations238[10].push({item : "238_Critical_VN11", s : "that the captain who the crew trusted /motivated the sailor, /and it /was nice to hear.", a : "x-x-x else okay cent hear located mom why suck volumes continent pre enters, goal wall jack sale sun anti.", n : "CLAIM FACT", q : "The sailor was motivated by ______?"})
  continuations238[10].push({item : "238_Critical_VN11", s : "that the captain who the crew trusted /commanded the sailor, /and it /was nice to hear.", a : "x-x-x else okay cent hear located mom why suck volumes continent pre enters, goal wall jack sale sun anti." , n : "CLAIM FACT", q : "The sailor was commanded by ______?" })
 
  continuations238[11].push({item : "238_Critical_VN12", s : "that the manager who the boss authorized /saddened the intern, /but it /seemed absurd.", a : "x-x-x else anti cent eat whereas pre jack onto illustrate savannah holy oppose, hill app movies runway.", n : "CLAIM FACT", q : "The intern was saddened by ______?"})
  continuations238[11].push({item : "238_Critical_VN12", s : "that the manager who the boss authorized /hired the intern, /but it /seemed absurd.", a : "x-x-x else anti cent eat whereas pre jack onto illustrate savannah holy oppose, hill app movies runway." , n : "CLAIM FACT", q : "The intern was hired by ______?" })
  ...
  continuations238[12].push({item : "238_Critical_VN13", s : "that the bully who the children hated /harassed the boy, /and it /was entirely correct.", a : "x-x-x breakdowns pre camp eat eaten yes lake enjoying villa vibrant jack nor, mark app note channels engines." , n : "CLAIM FACT ACCUSATION", q : "The boy was harassed by ______?" })

  continuations238[13].push({item : "238_Critical_VN14", s : "that the plaintiff who the jury interrogated /startled the witness, /and it /made it into the news.", a : "x-x-x else mom cent miss encompass holy dad till degeneration turnaround hill thunder, ice sun walk oh guys kid yeah.", n : "CLAIM FACT", q : "The witness was startled by ______?"})
  continuations238[13].push({item : "238_Critical_VN14", s : "that the plaintiff who the jury interrogated /interrupted the witness, /and it /made it into the news.", a : "x-x-x else mom cent miss encompass holy dad till degeneration turnaround hill thunder, ice sun walk oh guys kid yeah." , n : "CLAIM FACT", q : "The witness was interrupted by ______?" })
 
  continuations238[14].push({item : "238_Critical_VN15", s : "that the drunkard who the thug hit /stunned the bartender, /and it /sounded hilarious.", a : "x-x-x else week jack eat furlongs yeah sale lows pre phonology glad revisited, hill app buffalo announces.", n : "CLAIM FACT", q : "The bartender was stunned by ______?"})
  continuations238[14].push({item : "238_Critical_VN15", s : "that the drunkard who the thug hit /outwitted the bartender, /and it /sounded hilarious.", a : "x-x-x else week jack eat furlongs yeah sale lows pre phonology glad revisited, hill app buffalo announces." , n : "CLAIM FACT", q : "The bartender was outwitted by ______?" })
  ...
  continuations238[15].push({item : "238_Critical_VN16", s : "that the medic who the survivor thanked /greeted the surgeon, /but it /turned out to be untrue.", a : "x-x-x apart pre cent know della mid lake smoothly unicorn pyramid lord thereof, jack hill nation walk park hair caster." , n : "CLAIM", q : "The surgeon was greeted by _______?" })
 
  continuations238[16].push({item : "238_Critical_VN17", s : "that the lifeguard who the soldier taught /encouraged the swimmer, /and it /took the townspeople by surprise.", a : "x-x-x yours dad cent know diversify pre gift amongst button propose app opposes, laws tax vote ago republished vs believes.", n : "CLAIM FACT", q : "The swimmer was encouraged by ______?"})
  continuations238[16].push({item : "238_Critical_VN17", s : "that the lifeguard who the soldier taught /rescued the swimmer, /and it /took the townspeople by surprise.", a : "x-x-x yours dad cent know diversify pre gift amongst button propose app opposes, laws tax vote ago republished vs believes." , n : "CLAIM FACT", q : "The swimmer was rescued by ______?" })
  
  continuations238[17].push({item : "238_Critical_VN18", s : "that the fisherman who the gardener helped /delighted the politician, /and it /was on the news.", a : "x-x-x else bill jack miss entertain dad mom coincide mobile dividend app kilometers, guy pre ago announces nor whereas.", n : "CLAIM FACT", q : "The politician was delighted by ______?"})
  continuations238[17].push({item : "238_Critical_VN18", s : "that the fisherman who the gardener helped /admired the politician, /and it /was on the news.", a : "x-x-x else bill jack miss entertain dad mom coincide mobile dividend app kilometers, guy pre ago announces nor whereas." , n : "CLAIM FACT", q : "The politician was admired by ______?" })

  continuations238[18].push({item : "238_Critical_VN19", s : "that the janitor who the organizer criticized /amused the audience, /and it /was funny.", a : "x-x-x gone lose cent app onwards anti holy endorsing disclosure bundle jack includes, ago vs lord coast.", n : "CLAIM FACT", q : "The audience was amused by ______?"})
  continuations238[18].push({item : "238_Critical_VN19", s : "that the janitor who the organizer criticized /ignored the audience, /and it /was funny.", a : "x-x-x gone lose cent app onwards anti holy endorsing disclosure bundle jack includes, ago vs lord coast." , n : "CLAIM FACT", q : "The audience was ignored by ______?" })
 
  continuations238[19].push({item : "238_Critical_VN20", s : "that the investor who the scientist detested /disappointed the entrepreneur, /and it /drove everyone crazy.", a : "x-x-x apart pre cent miss tolerate sir mom depending arousing ministries holy disabilities, fun camp cents consists mouth.", n : "CLAIM FACT", q : "The entrepreneur was disappointed by ______?"})
  continuations238[19].push({item : "238_Critical_VN20", s : "that the investor who the scientist detested /deceived the entrepreneur, /and it /drove everyone crazy.", a : "x-x-x apart pre cent miss tolerate sir mom depending arousing ministries holy disabilities, fun camp cents consists mouth." , n : "CLAIM FACT", q : "The entrepreneur was deceived by ______?" })
 
  continuations238[20].push({item : "238_Critical_VN21", s : "that the firefighter who the neighbor insulted /discouraged the homeowner, /but it /went unnoticed.", a : "x-x-x apart mid camp eat accelerates pre yes mutually twenties modules rate federated, miss vs gift disparity.", n : "CLAIM FACT", q : "The homeowner was discouraged by ______?"})
  continuations238[20].push({item : "238_Critical_VN21", s : "that the firefighter who the neighbor insulted /rescued the homeowner, /but it /went unnoticed.", a : "x-x-x apart mid camp eat accelerates pre yes mutually twenties modules rate federated, miss vs gift disparity." , n : "CLAIM FACT", q : "The homeowner was rescued by ______?" })
 
  continuations238[21].push({item : "238_Critical_VN22", s : "that the agent who the FBI sent /confused the criminal, /and it /was acknowledged.", a : "x-x-x gone pre cent miss forth mid ones TIL deep enjoying cup achieved, ball hill ice competitions.", n : "CLAIM FACT", q : "The criminal was confused by ______?"})
  continuations238[21].push({item : "238_Critical_VN22", s : "that the agent who the FBI sent /arrested the criminal, /and it /was acknowledged.", a : "x-x-x gone pre cent miss forth mid ones TIL deep enjoying cup achieved, ball hill ice competitions." , n : "CLAIM FACT", q : "The criminal was arrested by ______?" })
  
  continuations238[22].push({item : "238_Critical_VN23", s : "that the plumber who the apprentice consulted /puzzled the woman, /and it /was true.", a : "x-x-x apart cool cent walk flanked holy yeah deposition footsteps syllable mid shall, miss vs sea hill.", n : "CLAIM", q : "The woman was puzzled by ______?"})
  continuations238[22].push({item : "238_Critical_VN23", s : "that the plumber who the apprentice consulted /assisted the woman, /and it /was true.", a : "x-x-x apart cool cent walk flanked holy yeah deposition footsteps syllable mid shall, miss vs sea hill." , n : "CLAIM", q : "The woman was assisted by ______?" })

  continuations238[23].push({item : "238_Critical_VN24", s : "that the senator who the diplomat supported /troubled the opponent, /and it /deserved attention.", a : "x-x-x else foot jack miss discuss fun mid figuring breathing semester pre delivers, hour kids guessing chocolate.", n : "CLAIM FACT", q : "The opponent was troubled by ______?"})
  continuations238[23].push({item : "238_Critical_VN24", s : "that the senator who the diplomat supported /defeated the opponent, /and it /deserved attention.", a : "x-x-x else foot jack miss discuss fun mid figuring breathing semester pre delivers, hour kids guessing chocolate." , n : "CLAIM FACT", q : "The opponent was defeated by ______?" })

  continuations238[24].push({item : "238_Critical_VN25", s : "that the fiancé who the author met /startled the bride, /but it /did not surprise anyone.", a : "x-x-x else glad cent hear affirm holy jack beyond lake scramble app grams, pre vs sun yes downtown senate.", n : "CLAIM FACT", q : "The bride was startled by ______?"})
  continuations238[24].push({item : "238_Critical_VN25", s : "that the fiancé who the author met /married the bride, /but it /did not surprise anyone.", a : "x-x-x else glad cent hear affirm holy jack beyond lake scramble app grams, pre vs sun yes downtown senate." , n : "CLAIM FACT", q : "The bride was married by ______?" })
  ...
  continuations238[25].push({item : "238_Critical_VN26", s : "that the businessman who the sponsor backed /fired the employee, /and it /came as a disappointment.", a : "x-x-x formulated hair hour eat accommodate jack hill unaware angels kitchen wall diabetes, pass lie male join nor concentrations." , n : "CLAIM FACT ACCUSATION", q : "The employee was fired by ______?" })

  continuations238[26].push({item : "238_Critical_VN27", s : "that the thief who the detective caught /enraged the woman, /and it /broke her family's heart.", a : "x-x-x substrates dad cent bag watts holy mid renewable bottom resorts drop shall, pre jack click app deployed users.", n : "CLAIM FACT ACCUSATION", q : "The woman was enraged by ______?"})
  continuations238[26].push({item : "238_Critical_VN27", s : "that the thief who the detective caught /robbed the woman, /and it /broke her family's heart.", a : "x-x-x substrates dad cent bag watts holy mid renewable bottom resorts drop shall, pre jack click app deployed users." , n : "CLAIM FACT ACCUSATION", q : " The woman was robbed by ______?" })

  continuations238[27].push({item : "238_Critical_VN28", s : "that the criminal who the stranger distracted /baffled the officer, /and it /seemed concerning.", a : "x-x-x childbirth sea hour jack anywhere fat mom moreover adjustment fossils yeah follows, pre cent liquid referendum.", n : "CLAIM FACT ACCUSATION", q : "The officer was baffled by ______?"})
  continuations238[27].push({item : "238_Critical_VN28", s : "that the criminal who the stranger distracted /abducted the officer, /and it /seemed concerning.", a : "x-x-x childbirth sea hour jack anywhere fat mom moreover adjustment fossils yeah follows, pre cent liquid referendum." , n : "CLAIM FACT ACCUSATION", q : "The officer was abducted by ______?" })
  ...
  continuations238[30].push({item : "238_Critical_VN31", s : "that the trickster who the woman recognized /was acknowledged by the police, /and it /calmed people down.", a : "x-x-x else wish cent hear redevelop pre mom twice invitation guys destination push miss happen, app hill basins choose wind.", n : "CLAIM FACT", q : "The police acknowledged ______?"})
  continuations238[30].push({item : "238_Critical_VN31", s : "that the trickster who the woman recognized /was arrested by the police, /and it /calmed people down.", a : "x-x-x else wish cent hear redevelop pre mom twice invitation guys destination push miss happen, app hill basins choose wind." , n : "CLAIM FACT", q : "The police arrested ______?" })
    
  continuations238[31].push({item : "238_Critical_VN32", s : "that the politician who the farmer trusted /was refuted three days ago, /but it /did not bother the farmer.", a : "x-x-x apart mid hour know facilitate pre lake genres blowing yeah runways weird sell sale, jack guys mind sir client app relies.", n : "CLAIM FACT", q : "______ was refuted three days ago?"})
  continuations238[31].push({item : "238_Critical_VN32", s : "that the politician who the farmer trusted /was elected three days ago, /but it /did not bother the farmer.", a : "x-x-x apart mid hour know facilitate pre lake genres blowing yeah runways weird sell sale, jack guys mind sir client app relies." , n : "CLAIM FACT", q : "______ was elected three days ago?" })
    
  continuations238[32].push({item : "238_Critical_VN33", s : "that the politician who the banker bribed /seemed credible to everyone, /and it /gave John the chills.", a : "x-x-x else mom cent eat recognizes pre kid biking soften extent pharmacy cup episodes, bag hill hear Walk yeah filler.", n : "CLAIM FACT", q : "______ seemed credible to everyone?"})
  continuations238[32].push({item : "238_Critical_VN33", s : "that the politician who the banker bribed /seemed corrupt to everyone, /and it /gave John the chills.", a : "x-x-x else mom cent eat recognizes pre kid biking soften extent pharmacy cup episodes, bag hill hear Walk yeah filler." , n : "CLAIM FACT", q : "______ seemed corrput to everyone?" })
    
  continuations238[33].push({item : "238_Critical_VN34", s : "that the sculptor who the painter admired /made headlines in the US, /and it /did not surprise anyone.", a : "x-x-x apart mid cent miss coincide pre fat raining puppies tour exchanged hour guys OH, anti mom dad jack agencies option.", n : "CLAIM FACT", q : "______ made headlines in the US?"})
  continuations238[33].push({item : "238_Critical_VN34", s : "that the sculptor who the painter admired /made sculptures in the US, /and it /did not surprise anyone.", a : "x-x-x apart mid cent miss coincide pre fat raining puppies tour exchanged hour guys OH, anti mom dad jack agencies option." , n : "CLAIM FACT", q : "______ made sculptures in the US?" })
    
  continuations238[34].push({item : "238_Critical_VN35", s : "that the runner who the psychiatrist treated /was widely known in France, /but it /turned out to be incorrect.", a : "x-x-x apart sick cent miss admire anti lord philanthropy kingdom jack update anybody hear Affront, dad app handle need sir case workforce.", n : "CLAIM", q : "______ was widely known in France?"})
  continuations238[34].push({item : "238_Critical_VN35", s : "that the runner who the psychiatrist treated /won the marathon in France, /but it /turned out to be incorrect.", a : "x-x-x apart sick cent miss admire anti lord philanthropy kingdom jack update anybody hear Affront, dad app handle need sir case workforce." , n : "CLAIM", q : "______ won the marathon in France?" })
    
  continuations238[35].push({item : "238_Critical_VN36", s : "that the analyst who the banker trusted /appeared on TV this morning, /and it /was very believable.", a : "x-x-x apart sick hour eat whereas fun sir loudly tourist literacy pre AL yeah keeping, anti hill cent lake blueprints.", n : "CLAIM", q : "______ appeared on TV this morning?"})
  continuations238[35].push({item : "238_Critical_VN36", s : "that the analyst who the banker trusted /repaired the TV this morning, /and it /was very believable.", a : "x-x-x apart sick hour eat whereas fun sir loudly tourist literacy pre AL yeah keeping, anti hill cent lake blueprints." , n : "CLAIM", q : "______ repaired the TV this morning?" })
    
  continuations238[36].push({item : "238_Critical_VN37", s : "that the child who the medic rescued /was mentioned in newspapers, /and it /seemed very interesting.", a : "x-x-x else pre cent miss shown anti lake amend squeeze china amendment lady midfielder, goal jack senate vote partnership.", n : "CLAIM FACT", q : "______ was mentioned in newspapers?"})
  continuations238[36].push({item : "238_Critical_VN37", s : "that the child who the medic rescued /wrote articles in newspapers, /and it /seemed very interesting.", a : "x-x-x else pre cent miss shown anti lake amend squeeze china amendment lady midfielder, goal jack senate vote partnership." , n : "CLAIM FACT", q : "______ wrote articles in newspapers?" })
    
  continuations238[37].push({item : "238_Critical_VN38", s : "that the carpenter who the craftsman carried /confused the apprentice, /and it /came as a disappointment.", a : "x-x-x benefiting sea hour eat calculate mid mom lifetimes weekend blog app punishable, hate vs jack dad miss municipalities.", n : "CLAIM FACT ACCUSATION", q : "The apprentice was confused by ______?"})
  continuations238[37].push({item : "238_Critical_VN38", s : "that the carpenter who the craftsman carried /hurt the apprentice, /and it /came as a disappointment.", a : "x-x-x benefiting sea hour eat calculate mid mom lifetimes weekend blog app punishable, hate vs jack dad miss municipalities." , n : "CLAIM FACT ACCUSATION", q : "The apprentice was hurt by ______?" })

  continuations238[38].push({item : "238_Critical_VN39", s : "that the daughter who the sister found /frightened the grandmother, /and it /seemed concerning.", a : "x-x-x configured sea camp eat enjoying yeah mid toward click subsidies cent accountable, miss jack movies referendum.", n : "CLAIM FACT ACCUSATION", q : "The grandmother was frightened by ______?"})
  continuations238[38].push({item : "238_Critical_VN39", s : "that the daughter who the sister found /greeted the grandmother, /and it /seemed concerning.", a : "x-x-x configured sea camp eat enjoying yeah mid toward click subsidies cent accountable, miss jack movies referendum." , n : "CLAIM FACT ACCUSATION", q : "The grandmother was greeted by ______?" })
    
  continuations238[39].push({item : "238_Critical_VN40", s : "that the tenant who the foreman looked for /annoyed the shepherd, /but it /proved to be made up.", a : "x-x-x apart pre cent rose admire mid guy flanked videos ring madness week pandemic, anti jack pocket sit card guys app.", n : "CLAIM ACCUSATION", q : "The shepherd was annoyed by ______?"})
  continuations238[39].push({item : "238_Critical_VN40", s : "that the tenant who the foreman looked for /questioned the shepherd, /but it /proved to be made up.", a : "x-x-x apart pre cent rose admire mid guy flanked videos ring madness week pandemic, anti jack pocket sit card guys app." , n : "CLAIM ACCUSATION", q : "The shepard was questioned by ______?" })
    
  continuations238[40].push({item : "238_Critical_VN41", s : "that the pharmacist who the stranger saw /distracted the customer, /and it /sounded surprising.", a : "x-x-x yours sick cent miss conversely pre wild moreover lake complexity mid achieved, hill vs hardest capability.", n : "CLAIM FACT", q : "The customer was distracted by ______?"})
  continuations238[40].push({item : "238_Critical_VN41", s : "that the pharmacist who the stranger saw /questioned the customer, /and it /sounded surprising.", a : "x-x-x yours sick cent miss conversely pre wild moreover lake complexity mid achieved, hill vs hardest capability." , n : "CLAIM FACT", q : "The customer was questioned by ______?" })

  continuations238[41].push({item : "238_Critical_VN42", s : "that the surgeon who the patient thanked /shocked his colleagues, /but it /seemed to be untrue.", a : "x-x-x yours pre cent know raining hate ones towards modesty picnic trip midfielder, fun app dinner park nor techno.", n : "CLAIM", q : "His colleagues were shocked by ______?"})
  continuations238[41].push({item : "238_Critical_VN42", s : "that the surgeon who the patient thanked /cured his colleagues, /but it /seemed to be untrue.", a : "x-x-x yours pre cent know raining hate ones towards modesty picnic trip midfielder, fun app dinner park nor techno." , n : "CLAIM", q : "His colleagues were cured by ______?" })
