...
if (!Array.prototype.includes) {
  ...
  continuations238[1].push({item : "238_Critical_VN2", s : "that the doctor who the nurse mistrusted /cured the patients, /but it /seemed hard to believe.",a : "x-x-x else cash cent jack whilst pre holy reinforce arrowheads retailer mid enjoying, goal vs videos hill ring dollars."  , n : "CLAIM FACT", q : "The patients were cured by the ______?", q_ac : "doctor", q_aiS1 : "", q_aiS3 : "nurse"})
  ...
  continuations238[3].push({item : "238_Critical_VN4", s : "that the victim who the lawyer rescued /surprised the criminal, /and it /appeared on TV.",a : "x-x-x else anti cent eat toward mid lake teaming adviser overview jack involves, miss dad download hall grow.", n : "CLAIM FACT", q : "The criminal was surprised by the ______?", q_ac : "victim", q_aiS1 : "", q_aiS3 : "lawyer"})
  continuations238[3].push({item : "238_Critical_VN4", s : "that the victim who the lawyer rescued /sued the criminal, /and it /appeared on TV.",a : "x-x-x else anti cent eat toward mid lake teaming adviser overview jack involves, miss dad download hall grow." , n : "CLAIM FACT", q : "The criminal was sued by the ______?", q_ac : "victim", q_aiS1 : "", q_aiS3 : "lawyer"})
  ...
  continuations238[7].push({item : "238_Critical_VN8", s : "that the actor who the fans loved /greeted the director, /and it /appeared to be true.",a : "x-x-x apart mid hour eat shown pre hill ford miles treatise cup contains, laws app pregnant cent sir bill." , n : "CLAIM", q : "The director was greeted by the ______?", q_ac : "actor", q_aiS1 : "", q_aiS3 : "fans"})
  
  continuations238[8].push({item : "238_Critical_VN9", s : "that the banker who the analyst defrauded /excited the customer, /but it /proved to be made up.", a : "x-x-x yours sick cent know stroll cool bus staring hydroxide phoenix jack wherever, pre holy soccer kid runs ride hear.", n : "CLAIM", q : "The customer was excited by the ______?", q_ac : "banker", q_aiS1 : "", q_aiS3 : "analyst"})
  continuations238[8].push({item : "238_Critical_VN9", s : "that the banker who the analyst defrauded /trusted the customer, /but it /proved to be made up.", a : "x-x-x yours sick cent know stroll cool bus staring hydroxide phoenix jack wherever, pre holy soccer kid runs ride hear." , n : "CLAIM", q : "The customer was trusted by the ______?", q_ac : "banker", q_aiS1 : "", q_aiS3 : "analyst"})
  ...
  continuations238[12].push({item : "238_Critical_VN13", s : "that the bully who the children hated /surprised the boy, /and it /was entirely correct.", a : "x-x-x breakdowns pre camp eat eaten yes lake enjoying villa vibrant jack nor, mark app note channels engines.", n : "CLAIM FACT ACCUSATION", q : "The boy was surprised by the ______?", q_ac : "bully", q_aiS1 : "", q_aiS3 : "children"})
  continuations238[12].push({item : "238_Critical_VN13", s : "that the bully who the children hated /harassed the boy, /and it /was entirely correct.", a : "x-x-x breakdowns pre camp eat eaten yes lake enjoying villa vibrant jack nor, mark app note channels engines." , n : "CLAIM FACT ACCUSATION", q : "The boy was harassed by the ______?", q_ac : "bully", q_aiS1 : "", q_aiS3 : "children"})

  continuations238[13].push({item : "238_Critical_VN14", s : "that the plaintiff who the lawyer interrogated /startled the witness, /and it /made it into the news.", a : "x-x-x else mom cent miss encompass holy dad till degeneration turnaround hill thunder, ice sun walk oh guys kid yeah.", n : "CLAIM FACT", q : "The witness was startled by the ______?", q_ac : "plaintiff", q_aiS1 : "", q_aiS3 : "lawyer"})
  ...
  continuations238[20].push({item : "238_Critical_VN21", s : "that the neighbor who the firefighter insulted /discouraged the homeowner, /but it /went unnoticed.", a : "x-x-x apart mid camp eat accelerates pre yes mutually twenties modules rate federated, miss vs gift disparity.", n : "CLAIM FACT", q : "The homeowner was discouraged by the ______?", q_ac : "neighbor", q_aiS1 : "", q_aiS3 : "firefighter"})
  continuations238[20].push({item : "238_Critical_VN21", s : "that the neighbor who the firefighter insulted /rescued the homeowner, /but it /went unnoticed.", a : "x-x-x apart mid camp eat accelerates pre yes mutually twenties modules rate federated, miss vs gift disparity." , n : "CLAIM FACT", q : "The homeowner was rescued by the ______?", q_ac : "neighbor", q_aiS1 : "", q_aiS3 : "firefighter"})
  ...
  continuations238[25].push({item : "238_Critical_VN26", s : "that the businessman who the exectutives backed /fired the employee, /and it /came as a disappointment.", a : "x-x-x formulated hair hour eat accommodate jack hill unaware angels kitchen wall diabetes, pass lie male join nor concentrations." , n : "CLAIM FACT ACCUSATION", q : "The employee was fired by the ______?", q_ac : "businessman", q_aiS1 : "", q_aiS3 : "exectutives"})
  ...
  continuations238[29].push({item : "238_Critical_VN30", s : "that the commander who the president appointed /was confirmed yesterday, /and it /troubled people.", a : "x-x-x apart mid hall eat depending kid yeah ourselves boyfriend box streets adventure, dad cent suspense wonder.", n : "CLAIM FACT", q : "The ______ was confirmed yesterday?", q_ac : "commander", q_aiS1 : "", q_aiS3 : "president"})
  continuations238[29].push({item : "238_Critical_VN30", s : "that the commander who the president appointed /was fired yesterday, /and it /troubled people.", a : "x-x-x apart mid hall eat depending kid yeah ourselves boyfriend box streets adventure, dad cent suspense wonder." , n : "CLAIM FACT", q : "The ______ was fired yesterday?", q_ac : "commander", q_aiS1 : "", q_aiS3 : "president"})
    
  //continuations238[30].push({item : "238_Critical_VN31", s : "that the trickster who the woman recognized /was acknowledged by the police, /and it /calmed people down.", a : "x-x-x else wish cent hear redevelop pre mom twice invitation guys destination push miss happen, app hill basins choose wind.", n : "CLAIM FACT", q : "The police acknowledged the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""})
  //continuations238[30].push({item : "238_Critical_VN31", s : "that the trickster who the woman recognized /was arrested by the police, /and it /calmed people down.", a : "x-x-x else wish cent hear redevelop pre mom twice invitation guys destination push miss happen, app hill basins choose wind." , n : "CLAIM FACT", q : "The police arrested the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""})
    
  //continuations238[30].push({item : "238_Critical_VN32", s : "that the politician who the mayor trusted /was refuted three days ago, /but it /did not bother the farmer.", a : "x-x-x apart mid hour know facilitate pre lake genres blowing yeah runways weird sell sale, jack guys mind sir client app relies.", n : "CLAIM FACT", q : "The ______ was refuted three days ago?", q_ac : "politician", q_aiS1 : "", q_aiS3 : "mayor"})
  //continuations238[30].push({item : "238_Critical_VN32", s : "that the politician who the mayor trusted /was elected three days ago, /but it /did not bother the farmer.", a : "x-x-x apart mid hour know facilitate pre lake genres blowing yeah runways weird sell sale, jack guys mind sir client app relies." , n : "CLAIM FACT", q : "The ______ was elected three days ago?", q_ac : "politician", q_aiS1 : "", q_aiS3 : "mayor"})
    
  continuations238[30].push({item : "238_Critical_VN33", s : "that the politician who the banker bribed /seemed credible to everyone, /and it /gave John the chills.", a : "x-x-x else mom cent eat recognizes pre kid biking soften extent pharmacy cup episodes, bag hill hear Walk yeah filler.", n : "CLAIM FACT", q : "The ______ seemed credible to everyone?", q_ac : "politician", q_aiS1 : "", q_aiS3 : "banker"})
  continuations238[30].push({item : "238_Critical_VN33", s : "that the politician who the banker bribed /seemed corrupt to everyone, /and it /gave John the chills.", a : "x-x-x else mom cent eat recognizes pre kid biking soften extent pharmacy cup episodes, bag hill hear Walk yeah filler." , n : "CLAIM FACT", q : "The ______ seemed corrput to everyone?", q_ac : "politician", q_aiS1 : "", q_aiS3 : "banker"})
    
  //continuations238[33].push({item : "238_Critical_VN34", s : "that the sculptor who the painter admired /made headlines in the US, /and it /did not surprise anyone.", a : "x-x-x apart mid cent miss coincide pre fat raining puppies tour exchanged hour guys OH, anti mom dad jack agencies option.", n : "CLAIM FACT", q : "The ______ made headlines in the US?", q_ac : "", q_aiS1 : "", q_aiS3 : ""})
  //continuations238[33].push({item : "238_Critical_VN34", s : "that the sculptor who the painter admired /made sculptures in the US, /and it /did not surprise anyone.", a : "x-x-x apart mid cent miss coincide pre fat raining puppies tour exchanged hour guys OH, anti mom dad jack agencies option." , n : "CLAIM FACT", q : "The ______ made sculptures in the US?", q_ac : "", q_aiS1 : "", q_aiS3 : ""})
    
  //continuations238[34].push({item : "238_Critical_VN35", s : "that the runner who the psychiatrist treated /was widely known in France, /but it /turned out to be incorrect.", a : "x-x-x apart sick cent miss admire anti lord philanthropy kingdom jack update anybody hear Affront, dad app handle need sir case workforce.", n : "CLAIM", q : "The ______ was widely known in France?", q_ac : "", q_aiS1 : "", q_aiS3 : ""})
  //continuations238[34].push({item : "238_Critical_VN35", s : "that the runner who the psychiatrist treated /won the marathon in France, /but it /turned out to be incorrect.", a : "x-x-x apart sick cent miss admire anti lord philanthropy kingdom jack update anybody hear Affront, dad app handle need sir case workforce." , n : "CLAIM", q : "The ______ won the marathon in France?", q_ac : "", q_aiS1 : "", q_aiS3 : ""})
    
  continuations238[31].push({item : "238_Critical_VN36", s : "that the analyst who the banker trusted /appeared on TV this morning, /and it /was very believable.", a : "x-x-x apart sick hour eat whereas fun sir loudly tourist literacy pre AL yeah keeping, anti hill cent lake blueprints.", n : "CLAIM", q : "The ______ appeared on TV this morning?", q_ac : "analyst", q_aiS1 : "", q_aiS3 : "banker"})
  continuations238[31].push({item : "238_Critical_VN36", s : "that the analyst who the banker trusted /repaired the TV this morning, /and it /was very believable.", a : "x-x-x apart sick hour eat whereas fun sir loudly tourist literacy pre AL yeah keeping, anti hill cent lake blueprints." , n : "CLAIM", q : "The ______ repaired the TV this morning?", q_ac : "analyst", q_aiS1 : "", q_aiS3 : "banker"})
    
  continuations238[32].push({item : "238_Critical_VN37", s : "that the child who the medic rescued /was mentioned in newspapers, /and it /seemed very interesting.", a : "x-x-x else pre cent miss shown anti lake amend squeeze china amendment lady midfielder, goal jack senate vote partnership.", n : "CLAIM FACT", q : "The ______ was mentioned in newspapers?", q_ac : "child", q_aiS1 : "", q_aiS3 : "medic"})
  continuations238[32].push({item : "238_Critical_VN37", s : "that the child who the medic rescued /wrote articles in newspapers, /and it /seemed very interesting.", a : "x-x-x else pre cent miss shown anti lake amend squeeze china amendment lady midfielder, goal jack senate vote partnership." , n : "CLAIM FACT", q : "The ______ wrote articles in newspapers?", q_ac : "child", q_aiS1 : "", q_aiS3 : "medic"})
    
  continuations238[33].push({item : "238_Critical_VN38", s : "that the carpenter who the craftsman carried /confused the apprentice, /and it /came as a disappointment.", a : "x-x-x benefiting sea hour eat calculate mid mom lifetimes weekend blog app punishable, hate vs jack dad miss municipalities.", n : "CLAIM FACT ACCUSATION", q : "The apprentice was confused by the ______?", q_ac : "carpenter", q_aiS1 : "", q_aiS3 : "craftsman"})
  ...
  continuations238[36].push({item : "238_Critical_VN41", s : "that the pharmacist who the stranger saw /distracted the customer, /and it /sounded surprising.", a : "x-x-x yours sick cent miss conversely pre wild moreover lake complexity mid achieved, hill vs hardest capability.", n : "CLAIM FACT", q : "The customer was distracted by the ______?", q_ac : "pharmacist", q_aiS1 : "", q_aiS3 : "stranger"})
  continuations238[36].push({item : "238_Critical_VN41", s : "that the pharmacist who the stranger saw /questioned the customer, /and it /sounded surprising.", a : "x-x-x yours sick cent miss conversely pre wild moreover lake complexity mid achieved, hill vs hardest capability." , n : "CLAIM FACT", q : "The customer was questioned by the ______?", q_ac : "pharmacist", q_aiS1 : "", q_aiS3 : "stranger"})

  //continuations238[41].push({item : "238_Critical_VN42", s : "that the surgeon who the patient thanked /shocked his colleagues, /but it /seemed to be untrue.", a : "x-x-x yours pre cent know raining hate ones towards modesty picnic trip midfielder, fun app dinner park nor techno.", n : "CLAIM", q : "His colleagues were shocked by the ______?", q_ac : "surgeon", q_aiS1 : "", q_aiS3 : ""})
  //continuations238[41].push({item : "238_Critical_VN42", s : "that the surgeon who the patient thanked /cured his colleagues, /but it /seemed to be untrue.", a : "x-x-x yours pre cent know raining hate ones towards modesty picnic trip midfielder, fun app dinner park nor techno." , n : "CLAIM", q : "His colleagues were cured by the ______?", q_ac : "surgeon", q_aiS1 : "", q_aiS3 : ""})
  ...
  fillers.push({s:"The mathematician at the banquet baffled the philosopher although she rarely needed anyone else's help. philosopher", a:"x-x-x rebelling trip lot corpses audible kept inspections appeared card branch moving happen polish oh. mathematician", q : "The ______ was baffled at the banquet?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The showman travels to different cities every month. showman", a:"x-x-x citing terrain hall certainly listen write rates. month", q : "The ______ travels to different cities?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The roommate takes out the garbage every week. roommate", a:"x-x-x attest doubt sold lose enables worst anti. week", q : "The garbage is taken out by the ______", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The dragon wounded the knight although he was far too crippled to protect the princess. knight", a:"x-x-x endorses funding plan borrow question walk tree pop key teammate stay society map indicate. princess", q : "The dragon wounded the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The office-worker worked through the stack of files on his desk quickly. files", a:"x-x-x appreciating forget arrived lady prone wife treat fall born rain western. desk", q : "The office worker worked through the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The firemen at the scene apprehended the arsonist because there was a great deal of evidence pointing to his guilt. firemen", a:"x-x-x originate war sure among outsourcing cent deviance anymore mouth fun us enter laws yes produced observer plus bill weigh. guilt", q : "The arsonist was apprehended by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"During the season, the choir holds rehearsals in the church regularly. choir", a:"x-x-x nice called, us haunt anger prophecies laws thus issues customers. season", q : "Rehearsals are held by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The speaker who the historian offended kicked a chair after the talk was over and everyone had left the room. speaker", a:"x-x-x criticises holy sad activated fraction upside mom files cases lot know port lord holy products port van guy how. historian", q : "The chair was kicked by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The milkman punctually delivers the milk at the door every day. milkman", a:"x-x-x obstruct clerestory lesbians lose quit ass nor took weird join. door", q : "The ______ delivers the milk?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The quarterback dated the cheerleader although this hurt her reputation around school. cheerleader", a:"x-x-x empties fairy sit propagation violence tell east lake represents access placed. school", q : "The quarterback dated the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The citizens of France eat oysters. citizens", a:"x-x-x allege anti Amount girl lattice. clams", q : "Oysters are eaten by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The bully punched the kid after all the kids had to leave to go to class. bully", a:"x-x-x arousing rituals eat what birth felt ha ha sun lake forms link jack size feels. class", q : "The kid was punched by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"After the argument, the husband ignored his wife. wife", a:"x-x-x plus suggests, cent without harmony seen here. argument", q : "The husband ignored the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The engineer who the lawyer who was by the elevator scolded blamed the secretary but nobody listened to his complaints. engineer", a:"x-x-x succumbing oh ha defend feet mine ones ha shouting rescind ounces sort including ass happen infantry laws far protecting. lawyer", q : "The secretary was blamed by the ______", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The librarian put the book onto the shelf. shelf", a:"x-x-x impede east grow this wave grow bacon. librarian", q : "The book was put onto the ______", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The photographer processed the film on time. photographer", a:"x-x-x prematurely eliminate ago yes non nor. time", q : "The film was processed by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""})
  fillers.push({s:"The spider that the boy who was in the yard captured scared the dog since it was larger than the average spider. spider", a:"x-x-x enclosing sad cent been hell pro say jack earn resource expert file gets ended list per decide lady anti imagine quotes. boy", q : "The dog was scared by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The sportsman goes jogging in the park regularly. park", a:"x-x-x incurring hear outback hope fell been processes. road", q : "The sportsman goes jogging in the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The customer who was on the phone contacted the operator because the new long-distance pricing plan was extremely inconvenient. customer", a:"x-x-x equates okay yeah bill sun maybe desperate wish wondered married link an unfortunately chronic miss yes residence inscriptions. plan", q : "The operator was contacted by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The private tutor explained the assignment carefully. tutor", a:"x-x-x reproduce bumps amendment lot kilometers centuries. student", q : "The assignment was explained by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The audience who was at the club booed the singer before the owner of the bar could remove him from the stage. singer", a:"x-x-x solidly anti mid sir why me levee glad argued larger rich lying east done yes worse allows term file rose there. owner", q : "The audience booed the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The defender is constantly scolding the keeper. defender", a:"x-x-x disembark sick definition dilation yeah albeit. coach", q : "The keeper is scolded by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The hippies who the police at the concert arrested complained to the officials while the last act was going on stage. hippies", a:"x-x-x possesses sale room anyone oh fit writers resource completion kill cup discussed worst damn yes grow sick worry sir older. police", q : "The ______ complained to the officials?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The natives on the island captured the anthropologist because she had information that could help the tribe. natives", a:"x-x-x emanating fat else forget managers plan misconceptions release pick away combination die gonna damn gets shake. information", q : "The anthropologist was captured by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The trainee knew that the task which the director had set for him was impossible to finish within a week. task", a:"x-x-x recursively easy jack eat earn prime note together wind word lose anti girl commission gun served degree cup thus. director", q : "The ______ was impossible to finish?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The administrator who the nurse from the clinic supervised scolded the medic while a patient was brought into the emergency room. administrator", a:"x-x-x unmask hell fact forth none anti scales detectives pungent nice smoky match lake islands boys imagine view luck recommend able. nurse", q : "The medic was scolded by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The company was sure that its new product, which its researchers had developed, would soon be sold out. product", a:"x-x-x closely mind dad sir cent nor another, throw drug accompanied eyes everybody, south page ha trip whom. company", q : "The ______ would soon be sold out?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The astronaut that the journalists who were at the launch worshipped criticized the administrators after he discovered a potential leak in the fuel tank. astronaut", a:"x-x-x supervises oh oh necessarily bed sure size yeah hungry vigorously calculated died reinforcements gotta rose electrical kept countries dean pain told laid cat. journalists", q : "The administrators were criticized by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The janitor who the doorman who was at the hotel chatted with bothered a guest but the manager decided not to fire him for it. janitor", a:"x-x-x conclude fat us intakes east ones miss ha today bedding mid tendency vote woods oh law however healthy rest kid wide road lake jack. doorman", q : "The guest was bothered by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The technician at the show repaired the robot while people were taking a break for coffee. technician", a:"x-x-x devoting hate been guys comrades cup sells sweet stupid sale policy met today sale cannot. people", q : "The robot was repaired by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The salesman feared that the printer which the customer bought was damaged. customer", a:"x-x-x dosing robust walk bar knocked weeks mid sciences impact map premier. salesman", q : "The printer was bought by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The students studied the surgeon whenever he performed an important operation. surgeon", a:"x-x-x reused summary stay advised indicate file something cent president companies. students", q : "The operations are performed by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The locksmith can crack the safe easily. safe", a:"x-x-x exert okay firms met took agreed. wall", q : "The locksmith can crack the ______ easily?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The woman who was in the apartment hired the plumber despite the fact that he couldn't fix the toilet. woman", a:"x-x-x seeking cool sea hear ass basically plain lie jerseys reached eyes came mom sit football bell cent enters. toilet", q : "The plumber was hired by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"Yesterday the swimmer saw only a turtle at the beach. turtle", a:"x-x-x nice hurdles ways fund web intake anti sold china. whale", q : "The swimmer saw a ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The surgeon who the detective who was on the case consulted questioned the coroner because the markings on the body were difficult to explain. surgeon", a:"x-x-x responding way web belonging bad girl ways soul hope databases profitable soul bullion playing hour explores ball won fun hope statement town windows. detective", q : "The coroner was questioned by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The gangster who the detective at the club followed implicated the waitress because the police suspected he had murdered the shopkeeper. gangster", a:"x-x-x rejoining lack how arbitrary far came held economic contracted park realizes animals read except religions bed case displays size furthering. detective", q : "The waitress was implicated by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"During the party everybody was dancing to rock music. party", a:"x-x-x buy comes otherwise few monster pay ago agree. music", q : "Everybody was dancing at the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The fans at the concert loved the guitarist because he played with so much energy. fans", a:"x-x-x besting holy via citizen older seat cooperate limited keep cancer sit does mass months. band", q : "The guitarist was loved by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The intern comforted the patient because he was in great pain. intern", a:"x-x-x predate receptive wind noticed percent kid move park basis win. pain", q : "The patient was comforted by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The casino hired the daredevil because he was confident that everything would go according to plan. daredevil", a:"x-x-x commences sword yes universes protect does her describes add understand china six authority ways down. casino", q : "The ______ was confident?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The beggar is often scrounging for cigarettes. beggar", a:"x-x-x officially mid feels concourses fan agreements. cigarette", q : "The ______ is scrounging?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The cartoonist who the readers supported pressured the dean because she thought that censorship was never appropriate. cartoonist", a:"x-x-x diversifying heat god whoever communist legalized jack den perfect keep account oh affiliates feet learn description. readers", q : "The dean was pressured by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The prisoner who the guard attacked tackled the warden although he had no intention of trying to escape. prisoner", a:"x-x-x certainly luck fine aimed suitable teaming mind invent congress mom grow boy describes pick author walk poetry. guard", q : "The warden was tackled by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The passer-by threw the cardboard box into the trash-can with great force. trash-can", a:"x-x-x succumbs quiet draw equitable his lord wish quarterly born agree agree. passer-by", q : "The cardboard box was thrown into the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The biker who the police arrested ran a light since he was driving under the influence of alcohol. biker", a:"x-x-x rehabilitate risk glad except breaking pain goal exist reach till loss opinion rules nor presented find discuss. police", q : "The ______ ran a light?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The scientists who were in the lab studied the alien while the blood sample was run through the computer. alien", a:"x-x-x evict holy yes add goes bob monster son lacks wanna lie agree update wish ha reality note everyone. computer", q : "The scientists studied the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The student quickly finished his homework assignments. student", a:"x-x-x putting healthy southern wife airports magistrates. teacher", q : "The homework assignment was finished by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The environmentalist who the demonstrators at the rally supported calmed the crowd until security came and sent everyone home. environmentalist", a:"x-x-x angering yeah sad perpendicular bed lot valve marketing spills best laugh spend contract me sure mom function hair. demonstrators", q : "The crowd was calmed by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The producer shoots a new movie every year. producer", a:"x-x-x shortly pierce page anti enjoy peace mom. director", q : "A new movie is shot by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The rebels who were in the jungle captured the diplomat after they threatened to kill his family for not complying with their demands. rebels", a:"x-x-x memorably girl body soul girl visits memories card nuisance feels guys scientists says able move please pain ball nostalgic sir learn drivers. family", q : "The diplomat was threatened by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"Dinosaurs ate other reptiles during the stone age. dinosaurs", a:"x-x-x earl write exporter minute guys wants dad. stone-age", q : "Reptiles were eaten by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The manager who the baker loathed spoke to the new pastry chef because he had instituted a new dress code for all employees. manager", a:"x-x-x contemplates anti map walks tenuous voted ass goal anti devoid skip weekend star mind veterinary lose dad sides want rose knew indicates. baker", q : "The ______ spoke to the new pastry chef?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The teacher doubted that the test that had taken him a long time to design would be easy to answer. test", a:"x-x-x totalling grinder star feet them your miss miles song anti oh her ha posted enjoy door fund foot county. teacher", q : "The ______ would be easy to answer?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
  fillers.push({s:"The cook who the servant in the kitchen hired offended the butler and then left the mansion early to see a movie at the local theater. cook", a:"x-x-x admirably trip cell justify cool lose wanting rough collapse runs thirds gold term miss rate evolved ideas bill code mean miles yeah hear their acquire. servant", q : "The butler was offended by the ______?", q_ac : "", q_aiS1 : "", q_aiS3 : ""}) 
