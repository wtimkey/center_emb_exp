...
if (!Array.prototype.includes) {
  ...
  continuations238[31].push({item : "238_Critical_VN32", s : "that the carpenter who the craftsman taught /interested the apprentice, /and it /came as a disappointment.", a : "x-x-x benefiting sea hour eat calculate mid mom lifetimes weekend blog app punishable, hate vs jack dad miss municipalities.", n : "CLAIM FACT ACCUSATION", q : "The apprentice was interested by the ______?", q_ac : "carpenter", q_aiS1 : "", q_aiS3 : "craftsman"})
  ...
  fillers.push({s:"The showman travels to different cities every month. showman", a:"x-x-x citing terrain hall certainly listen write rates. month", q : "The ______ travels to different cities?", q_ac : "showman", q_aiS1 : "magician", q_aiS3 : "month"}) 
  fillers.push({s:"The roommate takes out the garbage every week. roommate", a:"x-x-x attest doubt sold lose enables worst anti. week", q : "The garbage is taken out by the ______", q_ac : "roommate", q_aiS1 : "parents", q_aiS3 : "children"}) 
  fillers.push({s:"The dragon wounded the knight although he was far too crippled to protect the princess. knight", a:"x-x-x endorses funding plan borrow question walk tree pop key teammate stay society map indicate. princess", q : "The dragon wounded the ______?", q_ac : "knight", q_aiS1 : "princess", q_aiS3 : "king"}) 
  fillers.push({s:"The office-worker worked through the stack of files on his desk quickly. files", a:"x-x-x appreciating forget arrived lady prone wife treat fall born rain western. desk", q : "The office-worker worked through the ______?", q_ac : "files", q_aiS1 : "desk", q_aiS3 : "budget"}) 
  ...
  fillers.push({s:"During the season, the choir holds rehearsals in the church regularly. choir", a:"x-x-x nice called, us haunt anger prophecies laws thus issues customers. season", q : "Rehearsals are held by the ______?", q_ac : "choir", q_aiS1 : "season", q_aiS3 : "band"}) 
  ...
  fillers.push({s:"The milkman punctually delivers the milk at the door every day. milkman", a:"x-x-x obstruct clerestory librarians lose quit ats nor took weird join. door", q : "The ______ delivers the milk?", q_ac : "milkman", q_aiS1 : "cyclist", q_aiS3 : "mother"}) 
  fillers.push({s:"The quarterback dated the cheerleader although this hurt her reputation around school. cheerleader", a:"x-x-x empties fairy sit propagation violence tell east lake represents access placed. school", q : "The quarterback dated the ______?", q_ac : "cheerleader", q_aiS1 : "model", q_aiS3 : "school"}) 
  fillers.push({s:"The citizens of France eat oysters. citizens", a:"x-x-x allege anti Amount girl lattice. clams", q : "Oysters are eaten by the ______?", q_ac : "citizens", q_aiS1 : "clams", q_aiS3 : "otters"}) 
  fillers.push({s:"The bully punched the kid after all the kids had to leave to go to class. bully", a:"x-x-x arousing rituals eat what birth felt ha ha sun lake forms link jack size feels. class", q : "The kid was punched by the ______?", q_ac : "bully", q_aiS1 : "class", q_aiS3 : "thief"}) 
  fillers.push({s:"After the argument, the husband ignored his wife. wife", a:"x-x-x plus suggests, cent without harmony seen here. argument", q : "The husband ignored the ______?", q_ac : "wife", q_aiS1 : "argument", q_aiS3 : "child"}) 
  fillers.push({s:"The engineer who the lawyer who was by the elevator scolded blamed the secretary but nobody listened to his complaints. engineer", a:"x-x-x succumbing oh ha defend feet mine ones ha shouting rescind ounces sort including ats happen infantry laws far protecting. lawyer", q : "The secretary was blamed by the ______", q_ac : "engineer", q_aiS1 : "lawyer", q_aiS3 : "elevator"}) 
  fillers.push({s:"The librarian put the book onto the shelf. shelf", a:"x-x-x impede east grow this wave grow bacon. librarian", q : "The book was put onto the ______", q_ac : "shelf", q_aiS1 : "librarian", q_aiS3 : "cart"}) 
  fillers.push({s:"The photographer processed the film on time. photographer", a:"x-x-x prematurely eliminate ago yes non nor. time", q : "The film was processed by the ______?", q_ac : "photographer", q_aiS1 : "director", q_aiS3 : "time"})
  fillers.push({s:"The spider that the boy who was in the yard captured scared the dog since it was larger than the average spider. spider", a:"x-x-x enclosing sad cent been hell pro say jack earn resource expert file gets ended list per decide lady anti imagine quotes. boy", q : "The dog was scared by the ______?", q_ac : "spider", q_aiS1 : "boy", q_aiS3 : "yard"}) 
  fillers.push({s:"The sportsman goes jogging in the park regularly. park", a:"x-x-x incurring hear outback hope fell been processes. road", q : "The sportsman goes jogging in the ______?", q_ac : "park", q_aiS1 : "road", q_aiS3 : "track"}) 
  ...
  fillers.push({s:"The private tutor explained the assignment carefully. tutor", a:"x-x-x reproduce bumps amendment lot kilometers centuries. student", q : "The assignment was explained by the ______?", q_ac : "tutor", q_aiS1 : "general", q_aiS3 : "professor"}) 
  fillers.push({s:"The audience who was at the club booed the singer before the owner of the bar could remove him from the stage. singer", a:"x-x-x solidly anti mid sir why me levee glad argued larger rich lying east done yes worse allows term file rose there. owner", q : "The audience booed the ______?", q_ac : "singer", q_aiS1 : "owner", q_aiS3 : "club"}) 
  fillers.push({s:"The defender is constantly scolding the keeper. defender", a:"x-x-x disembark sick definition dilation yeah albeit. coach", q : "The keeper is scolded by the ______?", q_ac : "defender", q_aiS1 : "coach", q_aiS3 : "ball"}) 
  fillers.push({s:"The hippies who the police at the concert arrested complained to the officials while the last act was going on stage. hippies", a:"x-x-x possesses sale room anyone oh fit writers resource completion kill cup discussed worst darn yes grow sick worry sir older. police", q : "The ______ complained to the officials?", q_ac : "hippies", q_aiS1 : "police", q_aiS3 : "stage"}) 
  fillers.push({s:"The natives on the island captured the anthropologist because she had information that could help the tribe. natives", a:"x-x-x emanating fat else forget managers plan misconceptions release pick away combination die gonna darn gets shake. information", q : "The anthropologist was captured by the ______?", q_ac : "natives", q_aiS1 : "information", q_aiS3 : "hunters"}) 
  ...
  fillers.push({s:"The company was sure that its new product, which its researchers had developed, would soon be sold out. product", a:"x-x-x closely mind dad sir cent nor another, throw drug accompanied eyes everybody, south page ha trip whom. company", q : "The ______ would soon be sold out?", q_ac : "product", q_aiS1 : "company", q_aiS3 : "researchers"}) 
  ...
  fillers.push({s:"The janitor who the doorman who was at the hotel chatted with bothered a guest but the manager decided not to fire him for it. janitor", a:"x-x-x conclude fat us intakes east ones miss ha today bedding mid tendency vote woods oh law however healthy rest kid wide road lake jack. doorman", q : "The guest was bothered by the ______?", q_ac : "janitor", q_aiS1 : "doorman", q_aiS3 : "manager"}) 
  fillers.push({s:"The technician at the show repaired the robot while people were taking a break for coffee. technician", a:"x-x-x devoting hate been guys comrades cup sells sweet stupid sale policy met today sale cannot. people", q : "The robot was repaired by the ______?", q_ac : "technician", q_aiS1 : "people", q_aiS3 : "break"}) 
  fillers.push({s:"The salesman feared that the printer which the customer bought was damaged. customer", a:"x-x-x dosing robust walk bar knocked weeks mid sciences impact map premier. salesman", q : "The printer was bought by the ______?", q_ac : "customer", q_aiS1 : "salesman", q_aiS3 : "damage"}) 
  fillers.push({s:"The students studied the surgeon whenever he performed an important operation. surgeon", a:"x-x-x reused summary stay advised indicate file something cent president companies. students", q : "The operations are performed by the ______?", q_ac : "surgeon", q_aiS1 : "students", q_aiS3 : "study"}) 
  fillers.push({s:"The locksmith can crack the safe easily. safe", a:"x-x-x exert okay firms met took agreed. wall", q : "The locksmith can crack the ______ easily?", q_ac : "safe", q_aiS1 : "wall", q_aiS3 : "plumber"}) 
  fillers.push({s:"The woman who was in the apartment hired the plumber despite the fact that he couldn't fix the toilet. woman", a:"x-x-x seeking cool sea hear dad basically plain lie jerseys reached eyes came mom sit football bell cent enters. toilet", q : "The plumber was hired by the ______?", q_ac : "woman", q_aiS1 : "toilet", q_aiS3 : "apartment"}) 
  fillers.push({s:"Yesterday the swimmer saw only a turtle at the beach. turtle", a:"x-x-x nice hurdles ways fund web intake anti sold china. whale", q : "The swimmer saw a ______?", q_ac : "turtle", q_aiS1 : "whale", q_aiS3 : "lizard"}) 
  ...
  fillers.push({s:"During the party everybody was dancing to rock music. party", a:"x-x-x buy comes otherwise few monster pay ago agree. music", q : "Everybody was dancing at the ______?", q_ac : "party", q_aiS1 : "music", q_aiS3 : "concert"}) 
  fillers.push({s:"The fans at the concert loved the guitarist because he played with so much energy. fans", a:"x-x-x besting holy via citizen older seat cooperate limited keep cancer sit does mass months. band", q : "The guitarist was loved by the ______?", q_ac : "fans", q_aiS1 : "band", q_aiS3 : "manager"}) 
  fillers.push({s:"The intern comforted the patient because he was in great pain. intern", a:"x-x-x predate receptive wind noticed percent kid move park basis win. pain", q : "The patient was comforted by the ______?", q_ac : "intern", q_aiS1 : "pain", q_aiS3 : "nurse"}) 
  fillers.push({s:"The casino hired the daredevil because he was confident that everything would go according to plan. daredevil", a:"x-x-x commences sword yes universes protect does her describes add understand china six authority ways down. casino", q : "The ______ was confident?", q_ac : "daredevil", q_aiS1 : "casino", q_aiS3 : "plan"}) 
  fillers.push({s:"The beggar is often scrounging for cigarettes. beggar", a:"x-x-x officially mid feels concourses fan agreements. cigarette", q : "The ______ is scrounging?", q_ac : "beggar", q_aiS1 : "mouse", q_aiS3 : "officer"}) 
  ...
  fillers.push({s:"The passer-by threw the cardboard box into the trash-can with great force. trash-can", a:"x-x-x succumbs quiet draw equitable his lord wish quarterly born agree agree. passer-by", q : "The cardboard box was thrown into the ______?", q_ac : "trash-can", q_aiS1 : "passer-by", q_aiS3 : "fire"}) 
  fillers.push({s:"The biker who the police arrested ran a light since he was driving under the influence of alcohol. biker", a:"x-x-x rehabilitate risk glad except breaking pain goal exist reach till loss opinion rules nor presented find discuss. police", q : "The ______ ran a red light?", q_ac : "biker", q_aiS1 : "police", q_aiS3 : "alcohol"}) 
  fillers.push({s:"The scientists who were in the lab studied the alien while the blood sample was run through the computer. alien", a:"x-x-x evict holy yes add goes bob monster son lacks wanna lie agree update wish ha reality note everyone. computer", q : "The scientists studied the ______?", q_ac : "alien", q_aiS1 : "computer", q_aiS3 : "lab"}) 
  fillers.push({s:"The student quickly finished his homework assignments. student", a:"x-x-x putting healthy southern wife airports magistrates. teacher", q : "The homework assignment was finished by the ______?", q_ac : "student", q_aiS1 : "teacher", q_aiS3 : "parent"}) 
  ...
  fillers.push({s:"The producer shoots a new movie every year. producer", a:"x-x-x shortly pierce page anti enjoy peace mom. director", q : "A new movie is shot by the ______?", q_ac : "producer", q_aiS1 : "director", q_aiS3 : "cinematographer"}) 
  fillers.push({s:"The rebels who were in the jungle captured the diplomat after they threatened to kill his family for not complying with their demands. rebels", a:"x-x-x memorably girl body soul girl visits memories card nuisance feels guys scientists says able move please pain ball nostalgic sir learn drivers. family", q : "The diplomat was threatened by the ______?", q_ac : "rebels", q_aiS1 : "family", q_aiS3 : "jungle"}) 
  fillers.push({s:"Dinosaurs ate other reptiles during the stone age. dinosaurs", a:"x-x-x earl write exporter minute guys wants dad. stone-age", q : "Reptiles were eaten by the ______?", q_ac : "dinosaurs", q_aiS1 : "stone-age", q_aiS3 : "birds"}) 
  fillers.push({s:"The manager who the baker loathed spoke to the new pastry chef because he had instituted a new dress code for all employees. manager", a:"x-x-x contemplates anti map walks tenuous voted ats goal anti devoid skip weekend star mind veterinary lose dad sides want rose knew indicates. baker", q : "The ______ spoke to the new pastry chef?", q_ac : "manager", q_aiS1 : "baker", q_aiS3 : "employees"}) 
  fillers.push({s:"The teacher doubted that the test that had taken him a long time to design would be easy to answer. test", a:"x-x-x totalling grinder star feet them your miss miles song anti oh her ha posted enjoy door fund foot county. teacher", q : "The ______ would be easy to answer?", q_ac : "test", q_aiS1 : "teacher", q_aiS3 : "principal"}) 
  fillers.push({s:"The cook who the servant in the kitchen hired offended the butler and then left the mansion early to see a movie at the local theater. cook", a:"x-x-x admirably trip cell justify cool lose wanting rough collapse runs thirds gold term miss rate evolved ideas bill code mean miles yeah hear their acquire. servant", q : "The butler was offended by the ______?", q_ac : "cook", q_aiS1 : "servant", q_aiS3 : "movie"}) 
